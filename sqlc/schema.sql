...
CREATE TABLE palisade_signal (
	...
	strategy_version      INT NOT NULL DEFAULT 2,
...
CREATE TABLE paper_trade (
    ...
    status          TEXT NOT NULL,
    entry_mode      TEXT NOT NULL DEFAULT 'LIMIT_AT_SUPPORT',
    support_price   DOUBLE PRECISION NOT NULL DEFAULT 0,
    ...
    entry_low_price DOUBLE PRECISION NOT NULL DEFAULT 0,
    partial_profit_taken BOOLEAN NOT NULL DEFAULT false,
    quantity        DOUBLE PRECISION NOT NULL,
